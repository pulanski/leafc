...
/// Derive the `Dupe` trait, but without requiring all type arguments to
/// implement `Dupe`.
...
/// Derive the [`Clone` trait](Clone), but without requiring all type arguments
/// to implement [`Clone`](Clone).
...
/// Derive the [`Copy` trait](Copy), but without requiring all type arguments to
/// implement [`Copy`](Copy).
