...
///
/// The preamble is a comment block containing a warning not to edit the file by hand, and a link to
...
pub fn add_preamble(mut text: String, gen_kind: GeneratorKind) -> String {
    pub const GENERATOR: &str = "syntaxgen";
    let SOURCES = gen_kind.relevant_sources();
    let generated_note = format!("//! Generated by `{GENERATOR}`, do not edit by hand.\n//!\n//! To regenerate this file, run `cargo xtask syntaxgen`.\n//!\n//! Source files relevant to syntax generation include {SOURCES}\n");
...
/// The **kind** of source code to **generate**. This is used to generate different code for
/// different contexts (e.g. `SyntaxKind` vs `ast::Name`).
...
impl GeneratorKind {
    ...
    /// This is used to generate the top-level doc comment for the generated file.
    pub fn mod_doc_comment(&self) -> &'static str {
        match self {
            GeneratorKind::SyntaxKind => "//! This module contains the definition of the `SyntaxKind` enum, which is used to represent the different kinds of syntax nodes in the tree. This includes tokens (i.e. leaf nodes) as well as non-terminal nodes (i.e. internal nodes).",
