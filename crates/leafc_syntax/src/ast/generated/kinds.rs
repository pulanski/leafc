...
//!
//! Source files relevant to syntax generation include crates/leafc_syntax/src/syntaxgen/syntax_kind.rs.
//! This module contains the definition of the `SyntaxKind` enum, which is used to represent the different kinds of syntax nodes in the tree. This includes tokens (i.e. leaf nodes) as well as non-terminal nodes (i.e. internal nodes).
