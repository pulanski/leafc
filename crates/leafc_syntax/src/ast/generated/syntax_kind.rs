...
//! This module contains the definition of the `SyntaxKind` enum, which is used to represent the different kinds of syntax nodes in the tree. This includes tokens (i.e. leaf nodes) as well as non-terminal nodes (i.e. internal nodes).#![allow(bad_style, missing_docs, unreachable_pub)]
#![doc = "The **kind** of a **syntax node** found in the **syntax tree**."]
